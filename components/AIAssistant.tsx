    ...
    <div className="fixed bottom-6 right-6 z-50 no-print">
      {!isOpen && (
        <button
          ...
          className="bg-black text-white p-3 rounded-full shadow-lg hover:scale-105 transition-transform flex items-center gap-2"
        >
          <Sparkles size={18} />
          <span className="text-sm font-medium pr-1">Ask Nizamia</span>
        </button>
      )}
